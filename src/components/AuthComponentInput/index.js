...
const AuthComponentInput = ({ titleInput, iconInput, inputPlaceholder, isPassword }) => {
  return (
    <View style={styles.authComponentInput}>
        ...
        <View style={styles.authComponentInput_content_}>
            {iconInput}
            <TextInput placeholder={inputPlaceholder} style={styles.authComponentInput_contentInput} placeholderTextColor='black' secureTextEntry={isPassword} />
        </View>
    </View>
  )
}
