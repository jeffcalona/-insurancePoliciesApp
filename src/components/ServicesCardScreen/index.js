...
const ServicesCardScreen = ({ status, logo, name, description, price, id, descriptionL, backgroundImg, logoDetail, planes }) => {
    ...
    return (
        ...
        <View style={styles.servicesCardScreen_}>
            ...
            <View style={styles.servicesCardScreen_text}>
                ...
                {status === 'comprar' ? 
                    <TouchableOpacity onPress={() => navigation.navigate("DetailStack", { name: name, descriptionL: descriptionL, backgroundImg: backgroundImg, price: price, logo: logo, logoDetail: logoDetail, planes: planes })} style={styles.servicesCardCard_textActive}>
                        <Text style={styles.servicesCardCard_textButton} >Comprar</Text>                    
                    </TouchableOpacity>
                    :
                    <TouchableOpacity onPress={() => navigation.navigate("DetailStack", { name: name, descriptionL: descriptionL, backgroundImg: backgroundImg, price: price, logo: logo, logoDetail: logoDetail, planes: planes })} style={styles.servicesCardCard_textDisabled}>
